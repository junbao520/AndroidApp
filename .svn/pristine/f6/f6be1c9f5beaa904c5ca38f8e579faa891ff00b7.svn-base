...
namespace TwoPole.Chameleon3.Business.ExamItems.Foshan
{
    ...
    /// </summary>
    public class PrepareDriving : ExamItemBase
    {
        #region 检测项目
        /// <summary>
        /// 1，是否启用项目
        ...
        protected override void StopCore()
        {
            ...
            //打印出日志
            //Logger.Error("actualOrders:" + actualOrders);
           // Logger.Error("exceptOrders :" + exceptOrders);
            if (Settings.AroundCarEnable && !CheckAroundCarOrders())
            {
                CheckRule(true, DeductionRuleCodes.RC40101);
            }
