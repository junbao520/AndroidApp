...
namespace TwoPole.Chameleon3
{
    ...
    public class HuaZhongTest : Activity
    {
        ...
        private void InitUI()
        {
            ...
            InitControl();
            sw.Stop();
            Logger.Error("InitControl" + sw.Elapsed.TotalMilliseconds);

            sw = new Stopwatch();
            sw.Start();
            InitExamItemColor();
            sw.Stop();
            Logger.Error("InitExamItemColor" + sw.Elapsed.TotalMilliseconds);

            sw = new Stopwatch();
            sw.Start();
            InitExamItem();
            sw.Stop();
            Logger.Error("InitExamItem" + sw.Elapsed.TotalMilliseconds);

            sw = new Stopwatch();
            sw.Start();
            InitMapLines();
            sw.Stop();
            Logger.Error("InitMapLines" + sw.Elapsed.TotalMilliseconds);

            sw = new Stopwatch();
            sw.Start();
            BindExamModeSpinner();
            sw.Stop();
            Logger.Error("BindExamModeSpinner" + sw.Elapsed.TotalMilliseconds);
            sw = new Stopwatch();
            sw.Start();
            InitExamContext();
            sw.Stop();
            Logger.Error("InitExamContext" + sw.Elapsed.TotalMilliseconds);
            sw = new Stopwatch();
            sw.Start();
            InitModuleAsync(ExamContext.Map);
            sw.Stop();
            Logger.Error("InitModuleAsync" + sw.Elapsed.TotalMilliseconds);
