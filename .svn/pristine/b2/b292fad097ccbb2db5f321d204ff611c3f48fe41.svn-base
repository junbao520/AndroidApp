...
namespace TwoPole.Chameleon3
{
    ...
    public class DuoLunMobilePhone: Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.DuolunMobilePhone);
        ...
        public void ExamItemClick(object sender, EventArgs e)
        {
            try
            {
                ...
                //点击之后设置颜色 
                tvExamItem.SetTextColor(ColorStateList.ValueOf(Color.Orange));
        ...
        private void InitExamItem()
        {
            try
            {
                ...
                {
                    relativeLayout = (RelativeLayout)LayoutInflater.From(this).Inflate(Resource.Layout.ExamItemMobilePhone, null);
