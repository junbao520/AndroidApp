...
{
    /// <summary>
    /// 远近光交替2次(忽略应急灯，即开不开都可以)，往前推了1秒的检测时间
    /// </summary>
    public class LowAndHighBeamTwiceIgnoreCaution : LightRule
    {
        private readonly string[] _validPropertyNames = { "OutlineLight", "LowBeam", "HighBeam", "CautionLight" };
