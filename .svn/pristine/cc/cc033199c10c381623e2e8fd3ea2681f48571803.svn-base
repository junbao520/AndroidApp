...
namespace TwoPole.Chameleon3
{
   ...
   //[Activity(Label = "易考星", MainLauncher = true, Icon = "@drawable/iconnew")]
    public class VersionSelectChengDuActivity: Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.VersionSelectChengDu);
            try
            {
                InitControl();
                InitExamRoomInfo();
        ...
        {
            Toast.MakeText(this, "系统正在开发中,敬请期待!", ToastLength.Long).Show();
        }
        ...
        {
            var Item1= new KeyValuePair<int, KeyValuePair<string, string>>(Resource.Drawable.chengduduolun, new KeyValuePair<string, string>("多伦考场", DataBase.DuoLun));
            var Item2= new KeyValuePair<int, KeyValuePair<string, string>>(Resource.Drawable.chengduhuazhong, new KeyValuePair<string, string>("华众考场", DataBase.HuaZhong));
            var Item3 = new KeyValuePair<int, KeyValuePair<string, string>>(Resource.Drawable.chengdujingying, new KeyValuePair<string, string>("精英考场", DataBase.JingYing));
            var Item4 = new KeyValuePair<int, KeyValuePair<string, string>>(Resource.Drawable.chengduduolun2, new KeyValuePair<string, string>("备用考场", DataBase.BeiYong));
