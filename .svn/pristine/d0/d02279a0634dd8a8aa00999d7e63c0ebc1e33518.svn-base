...
namespace TwoPole.Chameleon3
{
    ...
    /// 华纵考试界面
    /// </summary>
    [Activity(Label = "HuaZhongSensor")]
    public class HuaZhong : BaseExamActivity
    {
        ...
        private void AndroidEnvironment_UnhandledExceptionRaiser(object sender, RaiseThrowableEventArgs e)
        {
            ...
            Logger.Error("HuaZhong AndroidEnvironment_UnhandledExceptionRaiser", msg);
        }
        ...
        private void InitControl()
        {
            ...
            btnRoundCar = FindViewById<Button>(Resource.Id.btnRoundCar);

            var btnArtificialEvaluation = FindViewById<Button>(Resource.Id.btnArtificialEvaluation);
            ...
            btnRoundCar.Click += BtnRoundCar_Click;
        ...
        //绕车一周结束
        private void BtnRoundCar_Click(object sender, EventArgs e)
        {
            btnRoundCar.Enabled = false;
            //发送上车准备完成的消息
        ...
        protected void RegisterMessages(object Objectmessenger)
        {
            ...
            messenger.Register<ExamFinishingMessage>(this, OnExamFinishingMessage);
            messenger.Register<PullOverTriggerMessage>(this, OnPullOverTrigger);
        }
        /// <summary>
        /// 自动触发靠边停车
        /// </summary>
        ...
        private void Txt_LongClick(object sender, View.LongClickEventArgs e)
        {
            try
            {
                ...
                // LogManager.WriteSystemLog("tvtext" + tv.Tag.ToString());
