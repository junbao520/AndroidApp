...
namespace TwoPole.Chameleon3.Business.Rules
{
    /// <summary>
    /// 小灯，近光和报警灯；
    /// 远光雾灯不能开启（不管左右转向灯，处理左右转不同步问题）
    /// </summary>
    public class OutlineAndCautionLightRule4 : LightRule
    {
        private readonly string[] _validPropertyNames = { "CautionLight", "OutlineLight", "LowBeam", "RightIndicatorLight", "LeftIndicatorLight" };
