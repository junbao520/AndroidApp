...
namespace TwoPole.Chameleon3.Business.Areas.HaiNan.SanYa.ExamItems
{
    ...
    public class PrepareDriving : ExamItemBase
    {
        ...
        protected override void ExecuteCore(CarSignalInfo signalInfo)
        {
            ...
            if (newExtraSensor != null)
            {
                ...
                if (!LastSensor.ArrivedTailstock && newExtraSensor.ArrivedTailstock)
                {
                    ...
                    Messenger.Send(new ExamStatusMessage("正经过车尾", LastSensor));
                }
        ...
        protected void ValidExtraSensor()
        {
            ...
            if (Settings.PrepareDrivingHeadStockEnable && !LastSensor.ArrivedHeadstock)
            {
                IsBreakRule = true;
            }
            if (Settings.PrepareDrivingTailStockEnable && !LastSensor.ArrivedTailstock)
            {
                IsBreakRule = true;
            }
