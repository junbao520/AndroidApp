...
namespace TwoPole.Chameleon3
{
    ...
    public class SanLian : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.SanLian);
        ...
        protected void UI_Load()
        {
            ...
            //泸县使用原来的美女头像，不要指纹图片
            if (DataBase.VersionNumber.Contains("佛山"))
                mgViewStart.SetImageResource(Resource.Drawable.gdStartExam);
        ...
        protected  void OnFingerprintMessage(FingerprintMessage message)
        {
            StartPrepare();
        ...
        protected  void OnVehicleStartingMessage(VehicleStartingMessage message)
        {
            //触发起步但是起步语音要变
            try
            {
            ...
            try
            {
                ...
                for (var i = 0; i < AllExamItems.Count(); i++)
                {
                    if (AllExamItems[i].ItemCode == message.ExamItem.ItemCode)
                    {
                        ...
                        {
                            CurentItemName = message.ExamItem.Name;
        ...
        public void btnStartExam_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (StartEndStatus)
                {
                   // mgViewStart.SetImageResource(Resource.Drawable.EndExam);
                    ...
                    if (DataBase.VersionNumber.Contains("佛山"))
                        mgViewStart.SetImageResource(Resource.Drawable.gdEndExam);
                    else
                       mgViewStart.SetImageResource(Resource.Drawable.EndExam);
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("SanLian StartExam:"+ex.Message);
            }
        ...
        private string CurentItemName = string.Empty;
        ...
        public void UpdateCarSensorState()
        {
            try
            {
                ...
                tvAngle.Text = "角度:" + carSignal.BearingAngle.ToString();
            }
            catch (Exception ex)
            {
